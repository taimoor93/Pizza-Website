...
<!-- menu -->
	<section class="portfolio py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="text-center mb-md-5 mb-4">
				<h3 class="title">Our <span>Menu</span></h3>
			</div>
			<div class="row mt-4">
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal1">
							<img src="images/menu/seekh_kabab.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">Seekh Kabab - <span>Rs.1200</span></h4>
						</a>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal2">
							<img src="images/menu/bbq.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">BBQ Buzz - <span>Rs.1200</span></h4>
						</a>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal3">
							<img src="images/menu/chicken_arabian.PNG" alt=" " class="img-fluid" />
							<h4 class="p-mask">Chicken Arabian - <span>Rs.1800</span></h4>
						</a>
					</div>
				</div>
			</div>
			<div class="row mt-md-5">
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal4">
							<img src="images/menu/super_silician.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">Super Sicilian - <span>Rs.1600</span></h4>
						</a>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal5">
							<img src="images/menu/afghani_tikka.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">Afghani Tikka - <span>Rs.1400</span></h4>
						</a>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
						<a href="#gal6">
							<img src="images/menu/bihari_chicken.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">Bihari Chicken - <span>Rs.1100</span></h4>
						</a>
					</div>
				</div>
			</div>
	...
	<div id="gal1" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/seekh_kabab.jpg" alt="">
			<h4 class="p-mask">Seekh Kabab Overload - - <span>Rs.1200</span></h4>
			<a href="order.php" class="button active mt-3">Order Now</a>
	...
	<div id="gal2" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/bbq.jpg" alt="">
			<h4 class="p-mask">BBQ Buzz - <span>Rs.1200</span></h4>
			<a href="order.php" class="button active mt-3">Order Now</a>
			<a class="close" href="#gallery">×</a>
		</div>
	...
	<div id="gal3" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/chicken_arabian.PNG" alt="">
			<h4 class="p-mask">Chicken Arabian - <span>Rs.1800</span></h4>
			<a href="order.php" class="button active mt-3">Order Now</a>
			<a class="close" href="#gallery">×</a>
		</div>
	...
	<div id="gal4" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/super_silician.jpg" alt="">
			<h4 class="p-mask">Super Sicilian - <span>Rs.1600</span></h4>
            <a href="order.php" class="button active mt-3">Order Now</a>
			<a class="close" href="#gallery">×</a>
		</div>
	...
	<div id="gal5" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/afghani_tikka.jpg" alt="">
			<h4 class="p-mask">Afghani Tikka - <span>Rs.1400</span></h4>
			<a href="order.php" class="button active mt-3">Order Now</a>
			<a class="close" href="#gallery">×</a>
		</div>
	...
	<div id="gal6" class="pop-overlay">
		<div class="popup popup-menu">
			<img class="img-fluid" src="images/menu/bihari_chicken.jpg" alt="">
			<h4 class="p-mask">Bihari Chicken - <span>Rs.1100</span></h4>
			<a href="order.php" class="button active mt-3">Order Now</a>
			<a class="close" href="#gallery">×</a>
		</div>
