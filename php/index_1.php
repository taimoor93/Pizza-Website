...
<body>
	...
	<div class="home_banner">
         <video autoplay muted loop >
             <source src="images/video_home/Pizza Hut Ad 2018 - (USA).mp4" type="video/mp4">
         </video>  
	</div>
    </center>
	<!-- //banner -->
	...
	<section class="portfolio py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section text-center mb-md-5 mb-4">
				<h3 class="title mb-3">Our <span>Special</span></h3>
			</div>
			<div class="row mt-4">
				<div class="col-md-4">
					<div class="gallery-demo">
							<img src="images/menu/seekh_kabab.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">Seekh Kabab Overload</h4>
						<center> <a href="menu.html" class="button active mt-3">View More</a> </center>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
							<img src="images/menu/bbq.jpg" alt=" " class="img-fluid" />
							<h4 class="p-mask">BBQ Buzz</h4>
						<center> <a href="menu.html" class="button active mt-3">View More</a> </center>
					</div>
				</div>
				<div class="col-md-4 mt-md-0 mt-4">
					<div class="gallery-demo">
							...
							<h4 class="p-mask">Chicken Arabian </h4>
                        <center> <a href="menu.html" class="button active mt-3">View More</a> </center>
					</div>
				</div>
			</div>
    ...
    <!-- home_second_banner -->
	<div class="home_second_banner">	</div>
	<!-- //home_second_banner -->
    
    <!-- home_third_banner -->
	<div class="home_third_banner">
       <a href="menu.html" class="button active mt-3">ORDER NOW</a>   
   	</div>
	<!-- //home_second_banner -->
    ...
    <!-- home_fourth_banner -->
	<div class="home_fourth_banner">	</div>
	<!-- //home_fourth_banner -->
